...
class Tree {
  ...
  public:
    ...
    void Draw(){
      ...
      limpiar.open("archivoBSTree.dot",ios::out); limpiar<<""; limpiar.close();

      archivo.open("archivoBSTree.dot",ios::app); 
      if(archivo.fail()){
      ...
      system("dot -Tjpg archivoBSTree.dot -o archivoBSTree.jpg");
    }
