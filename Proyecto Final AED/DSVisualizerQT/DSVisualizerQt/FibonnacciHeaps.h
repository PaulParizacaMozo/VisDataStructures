#ifndef FIBONNACCIHEAPS_H
#define FIBONNACCIHEAPS_H
    ...
    void menuFibonnacci()
    {
        ...
        while (salir == false)
        {
            ...
            case 4:
                ...
                cin >> aux;
                if(Fibo.find_bool(aux)){
                    cout << "  Ingrese el dato a ingresar -> ";
                    cin >> aux2;
                    Fibo.decrease_key(aux,aux2);
                    Fibo.print_2();
                    Fibo.Draw();
                    break;
                }
